  ...
  const projects = [
    {
      ...
      github: 'https://github.com/Burkakoo/my-web',
      demo: '#',
    },
    {
      id: 2,
      title: 'Employee Management App',
      description: 'A Web-App employee management application with real-time updates and team collaboration features.',
      tags: ['React Native', 'Firebase', 'Redux'],
      image: 'https://via.placeholder.com/600x400?text=Employee+Management+App',
      github: 'https://github.com/Burkakoo/Employee-management-system',
      demo: '#',
    },
    {
      id: 3,
      ...
      github: 'https://github.com/Burkakoo/my-portfolio',
      demo: '#',
    },
  ];
